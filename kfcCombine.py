...
class KFC_breakfast_window(QWidget):
    ...
    def setup_Ui(self):# string to write to file
        self.setObjectName("MainWindow")
        self.resize(800, 600)
        self.kfcBackpic = QtWidgets.QLabel(self.centralwidget)
        self.kfcBackpic.setGeometry(QtCore.QRect(0, 0, 800, 600))
        self.kfcBackpic.setText("")
        self.kfcBackpic.setPixmap(QtGui.QPixmap("./View/Pictures/kfcBackpic3.jpg"))
        ...
        self.centralwidget.setMinimumSize(QtCore.QSize(0, 1))
...
"}")
        ...
        self.BreakfastD_num = QtWidgets.QSpinBox(self.centralwidget)
        self.BreakfastD_num.setGeometry(QtCore.QRect(674, 170, 48, 26))
        self.BreakfastD_num.setObjectName("BreakfastD_num_2")

        self.KFCTea_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastF_3 = QtWidgets.QLabel(self.centralwidget)
        self.BreakfastF_3.setGeometry(QtCore.QRect(241, 232, 101, 101))
        self.BreakfastF_3.setText("")
        self.BreakfastF_3.setPixmap(QtGui.QPixmap("./View/Pictures/kfcBreakfast2.png"))
        self.BreakfastF_3.setScaledContents(True)
        self.BreakfastF_3.setObjectName("BreakfastF_3")

        self.BreakfastF_pric_2 = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastSetA_num = QtWidgets.QSpinBox(self.centralwidget)
        self.BreakfastSetA_num.setGeometry(QtCore.QRect(71, 172, 48, 26))
        self.BreakfastSetA_num.setObjectName("BreakfastSetA_num")

        self.BreakfastD_pric_2 = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastSetB_log = QtWidgets.QLabel(self.centralwidget)
        self.BreakfastSetB_log.setGeometry(QtCore.QRect(231, 30, 131, 91))
        self.BreakfastSetB_log.setText("")
        self.BreakfastSetB_log.setPixmap(QtGui.QPixmap("./View/Pictures/kfcBreakfastE.png"))
        self.BreakfastSetB_log.setScaledContents(True)
        self.BreakfastSetB_log.setObjectName("BreakfastSetB_log")

        self.BreakfastC_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastSetB_num = QtWidgets.QSpinBox(self.centralwidget)
        self.BreakfastSetB_num.setGeometry(QtCore.QRect(271, 170, 48, 26))
        self.BreakfastSetB_num.setObjectName("BreakfastSetB_num")

        self.BreakfastD_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCpepsi_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.kfcbreakfastC_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCTea_5 = QtWidgets.QLabel(self.centralwidget)
        self.KFCTea_5.setGeometry(QtCore.QRect(594, 202, 211, 141))
        self.KFCTea_5.setText("")
        self.KFCTea_5.setPixmap(QtGui.QPixmap("./View/Pictures/kfcTea.png"))
        self.KFCTea_5.setScaledContents(True)
        self.KFCTea_5.setObjectName("KFCTea_5")

        self.BlueButton3 = QtWidgets.QPushButton(self.centralwidget)
...
"}")
        ...
        self.KFCTea_pric_2 = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastC_num = QtWidgets.QSpinBox(self.centralwidget)
        self.BreakfastC_num.setGeometry(QtCore.QRect(473, 170, 48, 26))
        self.BreakfastC_num.setObjectName("BreakfastC_num")

        self.KFCPepsi_pric_2 = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastE_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastSetB_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BreakfastSetA_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.BlueButton2 = QtWidgets.QPushButton(self.centralwidget)
...
"}")
        ...
        self.dailyMenu_label = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFClogo = QtWidgets.QLabel(self.centralwidget)
        self.KFClogo.setGeometry(QtCore.QRect(10, 10, 71, 21))
        self.KFClogo.setText("")
        self.KFClogo.setPixmap(QtGui.QPixmap("./View/Pictures/kfc-logo.png"))
...
"Chart"))
    ...
    def add_to_cart(self):
        ...
        with open("/home/yiheng/qt_creater/cart.txt","w") as f:
...
class KFC_daily_window(QWidget):
    ...
    def setup_Ui(self):
        ...
        self.KFCsetA_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetB_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetB_num = QtWidgets.QSpinBox(self.centralwidget)
        self.KFCSetB_num.setGeometry(QtCore.QRect(268, 170, 48, 26))
        self.KFCSetB_num.setObjectName("KFCSetB_num")

        self.KFCSetB_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetB_3 = QtWidgets.QLabel(self.centralwidget)
        self.KFCSetB_3.setGeometry(QtCore.QRect(228, 30, 131, 91))
        self.KFCSetB_3.setText("")
        self.KFCSetB_3.setPixmap(QtGui.QPixmap("./View/Pictures/kfc2.png"))
        self.KFCSetB_3.setScaledContents(True)
        self.KFCSetB_3.setObjectName("KFCSetB_3")
        self.KFCSetC_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetC_num = QtWidgets.QSpinBox(self.centralwidget)
        self.KFCSetC_num.setGeometry(QtCore.QRect(470, 170, 48, 26))
        self.KFCSetC_num.setObjectName("KFCSetC_num")
        self.KFCSetC_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetC_3 = QtWidgets.QLabel(self.centralwidget)
        self.KFCSetC_3.setGeometry(QtCore.QRect(420, 30, 151, 101))
        self.KFCSetC_3.setText("")
        self.KFCSetC_3.setPixmap(QtGui.QPixmap("./View/Pictures/kfc3.png"))
        self.KFCSetC_3.setScaledContents(True)
        self.KFCSetC_3.setObjectName("KFCSetC_3")

        self.KFCSetD_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetE_num = QtWidgets.QSpinBox(self.centralwidget)
        self.KFCSetE_num.setGeometry(QtCore.QRect(67, 362, 48, 26))
        self.KFCSetE_num.setObjectName("KFCSetE_num")
        self.KFCSetE_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetF_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCSetF_2 = QtWidgets.QLabel(self.centralwidget)
        self.KFCSetF_2.setGeometry(QtCore.QRect(248, 212, 101, 141))
        self.KFCSetF_2.setText("")
        self.KFCSetF_2.setPixmap(QtGui.QPixmap("./View/Pictures/kfcSetH.png"))
        self.KFCSetF_2.setScaledContents(True)
        self.KFCSetF_2.setObjectName("KFCSetF_2")
        self.KFCSetF_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCPepsi_2 = QtWidgets.QLabel(self.centralwidget)
        self.KFCPepsi_2.setGeometry(QtCore.QRect(631, 232, 131, 91))
        self.KFCPepsi_2.setText("")
        self.KFCPepsi_2.setPixmap(QtGui.QPixmap("./View/Pictures/kfcpepci.png"))
        self.KFCPepsi_2.setScaledContents(True)
        self.KFCPepsi_2.setObjectName("KFCPepsi_2")
        self.KFCPepsi_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCFries_name = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCFries_num = QtWidgets.QSpinBox(self.centralwidget)
        self.KFCFries_num.setGeometry(QtCore.QRect(470, 362, 48, 26))
        self.KFCFries_num.setObjectName("KFCFries_num")
        self.KFCFries_pric = QtWidgets.QLabel(self.centralwidget)
        ...
        self.KFCFries_2 = QtWidgets.QLabel(self.centralwidget)
        self.KFCFries_2.setGeometry(QtCore.QRect(440, 212, 111, 111))
        self.KFCFries_2.setText("")
        self.KFCFries_2.setPixmap(QtGui.QPixmap("./View/Pictures/KFCFries.png"))
...
#buttons
        _translate = QtCore.QCoreApplication.translate
        self.ClearButton2 = QtWidgets.QPushButton(self.centralwidget)
...
"}")
        self.BlueButton.setObjectName("BlueButton")
        self.AddToChartButton = QtWidgets.QPushButton(self.centralwidget)
